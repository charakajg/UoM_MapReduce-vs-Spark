...
spark = SparkSession.builder.appName("PySparkTotalCarrierDelayPerYear").getOrCreate()
...
output_df = flightdelays_df.groupby("Year").sum("CarrierDelay")
output_df.write.mode("overwrite").csv("s3a://bda-test-data-1/spark_output/total_carrier_delay_per_year")

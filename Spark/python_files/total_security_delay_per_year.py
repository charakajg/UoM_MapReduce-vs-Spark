...
spark = SparkSession.builder.appName("PySparkTotalSecurityDelayPerYear").getOrCreate()
...
output_df = flightdelays_df.groupby("Year").sum("SecurityDelay")
output_df.write.mode("overwrite").csv("s3a://bda-test-data-1/spark_output/total_security_delay_per_year")

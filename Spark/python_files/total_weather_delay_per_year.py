...
spark = SparkSession.builder.appName("PySparkTotalWeatherDelayPerYear").getOrCreate()
...
output_df = flightdelays_df.groupby("Year").sum("WeatherDelay")
output_df.write.mode("overwrite").csv("s3a://bda-test-data-1/spark_output/total_weather_delay_per_year")

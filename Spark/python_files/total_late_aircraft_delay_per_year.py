...
spark = SparkSession.builder.appName("PySparkTotalLateAircraftDelayPerYear").getOrCreate()
...
output_df = flightdelays_df.groupby("Year").sum("LateAircraftDelay")
output_df.write.mode("overwrite").csv("s3a://bda-test-data-1/spark_output/total_late_aircraft_delay_per_year")
